...
class ResetLoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String title = AppLocalizations.of(context)!.forgotlogin;
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppLocalizations.of(context)!.forgotloginhint,
                  style: AppTextStyle.arsenal14Light,
                ),
                const SizedBox(height: 40),
                _ResetPassEmail(emailController: _passwordController),
